						...
						<div className='flex flex-wrap items-center mx-[-16px]'>
							...
							<div className='w-full lg:w-1/2 px-4'>
								<div className='text-center lg:text-right fadeIn-hidden'>
									<img src='images/about-image.svg' alt='about' className='max-w-full mx-auto lg:mr-0' />
								</div>
							</div>
						</div>
					</div>
					...
					<div className='flex flex-wrap items-center mx-[-16px]'>
						<div className='w-full lg:w-1/2 px-4'>
							<div className='text-center lg:text-left mb-12 lg:mb-0 fadeIn-hidden'>
								<img src='images/about-image-2.svg' alt='about' className='max-w-full mx-auto lg:ml-0' />
							</div>
						</div>
						<div className='w-full lg:w-1/2 px-4'>
